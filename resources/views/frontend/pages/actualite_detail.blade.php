...
@section('title', 'Details Actualité')
@section('description', $actualite->description ?? 'Aucune description disponible pour cette actualité.')
                ...
                <div class="col-lg-8" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                    <div class="blog-details__wrapper">
                        <div class="blog-details__wrapper__image">
                            <img class="img-fluid"
                                src="{{ URL::asset($actualite?->getFirstMediaUrl('image_detail') ?? '') }}"
                                alt="image fieni" />
                        </div>
                        <div class="blog-details__content">
                            <h2 class="blog-details__title my-3">{{ $actualite->titre ?? 'Aucune titre disponible.' }}</h2>


                            <p class="para">
                                {!! $actualite->description ?? 'Aucune actualite disponible.' !!}
                            </p>
