...
@section('content')
    ...
    <div class="row">
        <div class="text-end">
            ...
            @if ($data_biographie->count() == 0)
            <a href="{{ route('biographie.create') }}" class="btn btn-primary"> <i class="ri ri-add-fill"></i> Ajouter
                une
                biographie</a>
            @endif
        ...
        @foreach ($data_biographie as $item)
            <div class="col-sm-6 col-xl-4" id="row_{{ $item['id'] }}">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href=" {{ route('biographie.edit', $item['id']) }}"
