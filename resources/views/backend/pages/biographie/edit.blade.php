            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="{{ route('biographie.update', $data_biographie['id']) }}" novalidate
                        enctype="multipart/form-data">
                        @csrf

                       
                        <div class="col-md-4">
                            <img src="{{ $data_biographie->getFirstMediaUrl('image') }}" alt=""
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="status" class="form-control">
                                <option value="active" {{ $data_biographie['status'] == 'active' ? 'selected' : '' }}>
                                    Activé
                                </option>
                                <option value="desactive" {{ $data_biographie['status'] == 'desactive' ? 'selected' : '' }}>
                                    Desactivé</option>
                            </select>
                            <div class="valid-feedback">
                                Looks good!
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="tinymce-editor"> {!! $data_biographie['description'] !!}  </textarea><!-- End TinyMCE Editor -->
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
    ...
    <script>
        ...
        tinymce.init({
            ...
            images_upload_handler: function(blobInfo, success, failure) {
                ...
                fetch("{{ route('biographie.upload-tinymce') }}", {
                        method: 'POST',
                        headers: {
