...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="row g-3 needs-validation" method="post" action="{{ route('reference.store') }}" novalidate
                        enctype="multipart/form-data">
                        @csrf
                        {{-- <div class="col-md-4">
                            <label for="validationCustom01" class="form-label">Titre ou libellé </label>
                            <input type="text" name="titre" class="form-control" id="validationCustom01" required>
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="link" name="lien" class="form-control" id="validationCustom01">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
