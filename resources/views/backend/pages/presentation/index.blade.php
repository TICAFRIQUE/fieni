...
@section('content')
    ...
    <div class="row">
        <div class="text-end">
            ...
            @if ($data_presentation->count() == 0)
            <a href="{{ route('presentation.create') }}" class="btn btn-primary"> <i class="ri ri-add-fill"></i> Ajouter
                une
                presentation</a>
            @endif
        ...
        @foreach ($data_presentation as $item)
            <div class="col-sm-6 col-xl-4" id="row_{{ $item['id'] }}">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href=" {{ route('presentation.edit', $item['id']) }}"
