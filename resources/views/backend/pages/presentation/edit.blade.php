            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="{{ route('presentation.update', $data_presentation['id']) }}" novalidate
                        enctype="multipart/form-data">
                        @csrf

                        <div class="col-md-4">
                            <img src="{{ $data_presentation->getFirstMediaUrl('image') }}" alt="" class="img-fluid w-25">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="status" class="form-control">
                                <option value="active" {{ $data_presentation['status'] == 'active' ? 'selected' : '' }}>
                                    Activé
                                </option>
                                <option value="desactive"
                                    {{ $data_presentation['status'] == 'desactive' ? 'selected' : '' }}>
                                    Desactivé</option>
                            </select>
                            <div class="valid-feedback">
                                Looks good!
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="tinymce-editor"> {!! $data_presentation['description'] !!}  </textarea><!-- End TinyMCE Editor -->
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
    ...
    <script>
        ...
        tinymce.init({
            ...
            images_upload_handler: function(blobInfo, success, failure) {
                ...
                fetch("{{ route('presentation.upload-tinymce') }}", {
                        method: 'POST',
                        headers: {
