        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post" action="{{ route('presentation.store') }}" novalidate
...
@section('script')
    ...
    <script>
        ...
        // tinymce.init({
        //     language: 'fr_FR',
        //     language_url: 'build/tinymce/fr_FR.js', // à utiliser si tu charges la langue manuellement
