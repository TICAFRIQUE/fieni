        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="agendaForm" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row my-3">
                            <div class="col-md-9 border border-primary rounded p-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="titre" value="{{ $data_agenda['titre'] }}"
                            ...
                            <div class="col-md-3 border border-primary rounded p-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="lieu" class="form-control" value="{{ $data_agenda['lieu'] }}"
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        @foreach ($type as $key => $value)
                                            <option value="{{ $key }}" {{ $data_agenda['type'] == $key ? 'selected' : '' }} >{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
                                ...
                                <div class="row my-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="datetime-local" name="date_debut" class="form-control" value="{{ $data_agenda['date_debut'] }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="datetime-local" name="date_fin" class="form-control" value="{{ $data_agenda['date_fin'] }}"
                                            min="<?= date('Y-m-d') ?>">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <select name="is_public" class="form-control">
                                        <option value="1"  {{ $data_agenda['is_public'] == '1' ? 'selected' : '' }}>Oui</option>
                                        <option value="0" {{ $data_agenda['is_public'] == '0' ? 'selected' : '' }}>Non</option>
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
...
@section('script')
    ...
    <script>
        ...
        tinymce.init({
            ...
            images_upload_handler: function(blobInfo, success, failure) {
                ...
                fetch("{{ route('agenda.upload-tinymce') }}", {
                        method: 'POST',
                        headers: {
    ...
    `;
        ...
        $('#agendaForm').on('submit', function(e) {
            ...
            //recuperer id de l'agenda
            const agendaId = @json($id);

            $.ajax({
                url: "/admin/agenda/update/" + agendaId,
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
