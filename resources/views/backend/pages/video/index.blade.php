...
@section('content')
    ...
    <div class="row">
        <div class="text-end mb-4">
            <a href="{{ route('video.create') }}" class="btn btn-primary"> <i class="ri ri-add-fill"></i> Ajouter une
                video</a>
        </div>
            ...
            <div class="col-sm-6 col-xl-4" id="row_{{ $item['id'] }}">
                <div class="card">
                    <div class="video-container" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;">
                        <iframe src="https://www.youtube.com/embed/{{ $item['lien'] }}"
                    ...
                    <div class="card-body">
                        <p class="card-text mb-0">
                            Public: <span class="badge {{ $item['status'] == 'active' ? 'bg-success' : 'bg-danger' }}">
                                {{ $item['status'] == 'active' ? 'Oui' : 'Non' }} </span>
                        </p>
                        ...
                        <p class="card-text mb-0">
                            date de publication: <span class="badge bg-info"> {{ $item['created_at']->format('d-m-Y') }}
                            </span>
                        </p>
        ...
        @empty
            <h4 class="text-center">Aucun video disponible</h4>
        @endforelse
