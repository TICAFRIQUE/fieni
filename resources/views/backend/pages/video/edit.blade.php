        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="videoForm" class="row g-3 needs-validation" method="POST" action="{{ route('video.update', $data_video['id']) }}" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="row my-3">
                            <div class="col-md-9 border border-primary rounded p-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="titre" value="{{ $data_video['titre'] }}"
                            ...
                            <div class="col-md-3 border border-primary rounded p-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br><span>NB: Dans lien vous devez mettre uniquement l'ID de la vidéo YouTube.
                                        ...
                                        mettre  <span><span class="text-danger"> "abcd1234"</span> dans le champ lien. </span>
                                    ...
                                    <input type="text" name="lien" class="form-control"
                                        value="{{ $data_video['lien'] }}" id="validationCustom01" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <select name="status" class="form-control" required>
                                        <option value="active" {{ $data_video['status'] == 'active' ? 'selected' : '' }}>Oui
                                        </option>
                                        <option value="desactive"
                                            {{ $data_video['status'] == 'desactive' ? 'selected' : '' }}>Non</option>
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <select name="vedette" class="form-control" required>
                                        <option value="non" {{ $data_video['vedette'] == 'non' ? 'selected' : '' }}>Non
                                        </option>
                                        <option value="oui" {{ $data_video['vedette'] == 'oui' ? 'selected' : '' }}>Oui
                                        </option>
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
