            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="{{ route('temoignage.update', $data_temoignage['id']) }}" novalidate
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="col-md-12 my-3">
                                    ...
                                    <textarea name="description" class="tinymce-editor"> {!! $data_temoignage['description'] !!}  </textarea><!-- End TinyMCE Editor -->
                            ...
                            <div class="col-md-4 my-3">
                                  ...
                                  <div class="col-md-12 my-3">
                                    <label for="validationCustom01" class="form-label">Nom du temoin </label>
                                    <input type="text" name="nom" value="{{ $data_temoignage['nom'] }}" class="form-control">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 my-3">
                                    <label for="validationCustom01" class="form-label">Fonction du temoin </label>
                                    <input type="text" name="fonction" value="{{ $data_temoignage['fonction'] }}" class="form-control">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <img src="{{ $data_temoignage->getFirstMediaUrl('image') }}" alt=""
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="active" {{ $data_temoignage['status'] == 'active' ? 'selected' : '' }}>
                                            Activé
                                        </option>
                                        <option value="desactive"
                                            {{ $data_temoignage['status'] == 'desactive' ? 'selected' : '' }}>
                                            Desactivé</option>
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
    ...
    <script>
        ...
        tinymce.init({
            ...
            images_upload_handler: function(blobInfo, success, failure) {
                ...
                fetch("{{ route('flash-infos.upload-tinymce') }}", {
                        method: 'POST',
                        headers: {
