            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="{{ route('flash-infos.update', $data_flash['id']) }}" novalidate enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 my-3">
                                ...
                                <textarea name="description" class="tinymce-editor"> {!! $data_flash['description'] !!}  </textarea><!-- End TinyMCE Editor -->
                            ...
                            <div class="col-md-3 my-3">
                                {{-- <div class="col-md-4">
                            <img src="{{ $data_flash->getFirstMediaUrl('image') }}" alt=""
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="active" {{ $data_flash['status'] == 'active' ? 'selected' : '' }}>
                                            Activé
                                        </option>
                                        <option value="desactive"
                                            {{ $data_flash['status'] == 'desactive' ? 'selected' : '' }}>
                                            Desactivé</option>
                                    </select>
                                    <div class="valid-feedback">
                                        Looks good!
