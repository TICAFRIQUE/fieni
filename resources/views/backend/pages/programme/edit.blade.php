            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="post"
                        action="{{ route('programme.update', $data_programme['id']) }}" novalidate
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="status" class="form-control">
                                <option value="active" {{ $data_programme['status'] == 'active' ? 'selected' : '' }}>
                                    Activé
                                </option>
                                <option value="desactive" {{ $data_programme['status'] == 'desactive' ? 'selected' : '' }}>
                                    Desactivé</option>
                            </select>
                            <div class="valid-feedback">
                                Looks good!
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="tinymce-editor"> {!! $data_programme['description'] !!}  </textarea><!-- End TinyMCE Editor -->
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
